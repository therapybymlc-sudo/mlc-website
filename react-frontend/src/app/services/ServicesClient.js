...
const defaultServicesContent = {
  hero: {
    ...
    body_one:
      "<p>At MLC Health & Wellness Centre, we understand that healing is not linear, and that every individual, couple, and family experiences growth differently. Our ethical therapy services are designed to meet you where you are, blending empathy, structure, and internationally aligned standards of care.</p>",
    body_two:
    ...
    coverage_line:
      "<p>We provide secure therapy across Mumbai, Delhi, Bangalore, Hyderabad, Chennai, Pune, Kolkata, Ahmedabad and other major cities in India.</p>",
  },
  portal: {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes. Therapy sessions are absolute private and confidential. We use secure, HIPAA-compliant platforms for all interactions to ensure your privacy is protected.",
      },
    ],
  },
  cta: {
        ...
        <Container maxW="6xl">
          <VStack spacing={6} textAlign="center">
            ...
            <SimpleGrid columns={{ base: 1, md: 2 }} spacing={4} w="100%">
              <Button
                as={NextLink}
                href={content.portal.client_link}
                bg="#A9CBB7"
                color="#2E2E2E"
              ...
              <Button
                as={NextLink}
                href={content.portal.therapist_link}
                variant="outline"
        ...
        <Container maxW="7xl">
          ...
          <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} spacing={10}>
            {services.map((service) => (
              <Box
                as={NextLink}
                href={service.cta_link || service.link || "/services"}
          ...
          <Accordion allowToggle maxW="4xl" mx="auto">
            {content.faq.items.map((item, i) => (
              <AccordionItem key={i} border="none">
                ...
                <AccordionPanel pb={4} fontFamily="'Inter', var(--font-inter), sans-serif">
                  {item.a}
                </AccordionPanel>
              </AccordionItem>
            ))}
