              ...
              <Box bg="white" p={8} borderRadius="3xl" shadow="md" border="1px solid" borderColor="gray.100">
                <VStack align="start" spacing={6}>
                  ...
                  <VStack align="start" spacing={4} w="full">
                    ...
                    <HStack spacing={4} w="full" p={4} borderRadius="2xl" bg="mlc.greenHighlight" transition="0.2s" _hover={{ bg: 'rgba(86, 117, 109, 0.1)' }}>
                      <Circle size="40px" bg="white" shadow="sm">
                        <Icon as={FiPhone} color="mlc.green" />
                      </Circle>
                      <VStack align="start" spacing={0}>
                        <Text fontSize="xs" fontWeight="700" color="mlc.greenDark">PHONE & WHATSAPP</Text>
                        <HStack spacing={2}>
                          <Link href="tel:+919901619968" fontSize="sm" fontWeight="600" color="black" _hover={{ color: 'mlc.green' }}>
                            +91 99016 19968
                          </Link>
