...
const fallbackHome = {
  hero: {
    title: "MLC Health & Wellness Center",
    ...
    paragraph_two:
      "At MLC Health & Wellness Center, we offer thoughtful online therapy across India in spaces designed to help you feel heard, supported, and respected.",
